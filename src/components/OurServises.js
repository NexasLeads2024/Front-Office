      ...
      <div className="px-4 md:px-8 lg:px-16 mb-28 mt-20">
          ...
          {Object.keys(services).map((key) => {
            ...
            return (
              <button
                ...
                className={`${
                  currService.slug === service.slug ? "bg-[#e24545] text-black" : "bg-gray-200"
                } text-black font-bold rounded-full border-transparent transition-all duration-200 cursor-pointer tab-item font-chivo text-sm px-4 py-2 md:text-base md:px-6 md:py-3 lg:px-8 lg:py-4 hover:bg-[#e24545] hover:text-black border-2 hover:border-[#e24545]`}
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 mx-auto max-w-6xl">
          ...
          <div className="lg:w-2/3 p-4 md:p-6 lg:p-8">
            <h3 className="text-[#e24545] text-2xl font-bold text-center">
              {service.name}
            </h3>
