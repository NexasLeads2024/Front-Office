    ...
    <section className="body-font relative bg-[#e24545] text-white">
      <div className="container mx-auto px-5 py-24">
        <div className="mb-12 flex w-full flex-col text-center">
          <h1 className="title-font mb-5 text-5xl font-medium text-white sm:text-5xl">Contact Us</h1>
            ...
            <form onSubmit={handleSubmit} className="w-full">
              <div className="relative mb-4">
                <div className="w-full p-5 bg-white rounded-lg font-mono">
                  <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="input1">Name</label>
                  <input
              ...
              <div className="relative mb-4">
                <div className="w-full p-5 bg-white rounded-lg font-mono">
                  <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="input2">Email</label>
                  <input
                    className="text-sm custom-input w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm transition duration-300 ease-in-out transform focus:-translate-y-1 focus:border-[#e24545] hover:shadow-lg hover:border-[#e24545] bg-gray-100 text-black"
              ...
              <div className="relative mb-4">
                <div className="w-full p-5 bg-white rounded-lg font-mono">
                  <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="input3">Subject</label>
                  <input
                    className="text-sm custom-input w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm transition duration-300 ease-in-out transform focus:-translate-y-1 focus:border-[#e24545] hover:shadow-lg hover:border-[#e24545] bg-gray-100 text-black"
